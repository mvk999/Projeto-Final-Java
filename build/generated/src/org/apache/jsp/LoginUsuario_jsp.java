...
public final class LoginUsuario_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (session.getAttribute("nome") != null) {
    ...
    if (!(rs.next())) {
      ...
      out.write("        <h2>Obrigado por efetuar seu login!</h2>\n");
      out.write("        <span class=\"close\" onclick=\"window.location.href='index.jsp'\">&times;</span>\n");
      out.write("        <div class=\"text-sobre\">\n");
      out.write("            <p>Para garantir sua segurança, faça o logout sempre que sair do nosso site, clicando no link localizado na barra acima.</p>\n");
      out.write("            <p>Se surgirem dúvidas, não hesite em entrar em contato utilizando a seção 'Contato' acima.</p>\n");
      out.write("            <p class=\"fw-bold\">Sejam bem-vindos!!</p>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("</body>\n");
